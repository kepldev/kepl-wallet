...
const char COMMUNITY_FORUM_URL[] = "https://discord.gg/G3ZHfZG";
const char REPORT_ISSUE_URL[] = "https://www.kepl.org/#contact";
...
MainWindow::MainWindow(ICryptoNoteAdapter* _cryptoNoteAdapter, IAddressBookManager* _addressBookManager,
  ...
  m_ui->setupUi(this);
  setWindowTitle(tr("KEPL Wallet %1").arg(Settings::instance().getVersion()));

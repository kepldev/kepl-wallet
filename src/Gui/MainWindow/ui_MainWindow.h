...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        QIcon icon;
        icon.addFile(QStringLiteral(":/images/kepl"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        m_aboutkeplAction = new QAction(MainWindow);
        m_aboutkeplAction->setObjectName(QStringLiteral("m_aboutkeplAction"));
        m_aboutkeplAction->setEnabled(true);
        ...
        menuHelp->addAction(m_aboutkeplAction);
        ...
        QObject::connect(m_aboutkeplAction, SIGNAL(triggered()), MainWindow, SLOT(about()));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
...
#endif // QT_NO_TOOLTIP
        m_aboutkeplAction->setText(QApplication::translate("MainWindow", "About KEPL", 0));
...
#endif // QT_NO_TOOLTIP
        m_communityForumAction->setText(QApplication::translate("MainWindow", "Discord server", 0));
        ...
        m_sendButton->setText(QApplication::translate("MainWindow", "SEND KEPLs", 0));
